...
export default function HowItWorksPage() {
  return (
    <LegalPage title="How It Works">
      ...
      <h2 className="text-xl font-semibold text-white">Phase 1 — Challenge</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-white">Phase 2 — Verification</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold text-white">Funded Stage</h2>
      <p>
