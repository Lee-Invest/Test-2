...
export function TreeAccent() {
  return (
    <div
      aria-hidden
      className="pointer-events-none absolute inset-y-0 left-0 hidden w-80 overflow-hidden lg:block xl:w-[28rem]"
    ...
    >
      ...
      <img src="/tree.png" alt="" className="h-full w-full object-cover object-top" />
